...
public class ClassicMcElieceTestDecaps
    extends TestCase
{
        ...
        throws Exception
    {
        String[] files;
        files = new String[]{
            "std/additionalDecapTesting_6492.rsp",
            "f/additionalDecapTesting_6492.rsp",
            "std/additionalDecapTesting_13608.rsp",
            "f/additionalDecapTesting_13608.rsp",
            "std/additionalDecapTesting_13932.rsp",
            "f/additionalDecapTesting_13932.rsp",
            "std/additionalDecapTesting_13948.rsp",
            "f/additionalDecapTesting_13948.rsp",
            "std/additionalDecapTesting_14120.rsp",
            "f/additionalDecapTesting_14120.rsp"
        };
